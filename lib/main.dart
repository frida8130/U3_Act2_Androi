...
class Empresa extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      body: Center(
        child: Text("Seccion Empresa Angelica"),
      ), //finbody
    ); //fin de scaffold
  } //fin widget context
...
class Productos extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      body: Center(
        child: Text("Seccion Productos Angelica"),
      ), //finbody
    ); //fin de scaffold
  } //fin widget context
...
class Contactos extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      body: Center(
        child: Text("Seccion Contactos Angelica"),
      ), //finbody
    ); //fin de scaffold
  } //fin widget context
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      body: Container(
        ...
        decoration: BoxDecoration(color: Colors.cyan, image: DecorationImage(image: NetworkImage("https://github.com/frida8130/Mis_Imagenes/blob/main/herxd.jpg?raw=true"), alignment: Alignment.topCenter),
            ), //fin box decoration
